...
class AccountMoveInherit(models.Model):
    ...
    #             qties_per_lot[ml.chassis_number] -= ml.product_uom_id._compute_quantity(ml.qty_done, ml.product_id.uom_id)
    #             qties_per_lot[ml.engine_number] -= ml.product_uom_id._compute_quantity(ml.qty_done, ml.product_id.uom_id)
    #             qties_per_lot[ml.battery_number] -= ml.product_uom_id._compute_quantity(ml.qty_done, ml.product_id.uom_id)
    ...
    #             'chassis_number': 'joyanto',
    #             'engine_number': 'barmon',
    #             'battery_number': 'sree',
    #         })
    #     return lot_values